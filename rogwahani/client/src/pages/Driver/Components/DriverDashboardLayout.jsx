...
export default function DriverDashboardLayout({ children }) {
    ...
    return (
        <div className="min-h-screen bg-gray-900">
                ...
                <div className="h-full px-3 py-4 overflow-y-auto">
                    <nav className="space-y-6 pt-16">
                        ...
                        >
                            ...
                            >
                                <RiPhoneLine className="mr-2" /> 1800-108-108
                            </motion.a>
                        </motion.div>
                    </nav>
                </div>
                ...
                <nav className="fixed top-0 right-0 z-30 w-full bg-gray-800 border-b border-gray-700 px-4 py-2.5">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-6">
                            <motion.div
                                className="relative flex items-center px-3 py-1 rounded-lg bg-green-500/20 text-green-400"
                                whileHover={{ scale: 1.05 }}
                            >
            ...
            {/* Quick Action Button - Going Offline */}
            <motion.button
            ...
            >
                ...
                <span className="ml-2 hidden md:inline">Go Offline</span>
            </motion.button>
        </div>
    );
}
